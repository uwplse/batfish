   ...
   public void diffRepresentation(Object o, String string, boolean reverse) {
      if (reverse) {
         ...
         Util.diffRepresentationLists(null, _allowedVlans, string
               + "._allowedVlans");
         System.out.println("+ " + string + "._area:"
               + Util.objectToString(_area));
         ...
         System.out.println("+ " + string + "._routingPolicy:"
               + Util.objectToString(_routingPolicy));
         Util.diffRepresentationMaps(null, _secondaryIps, string
               + "._secondaryIps");
      ...
      if (o == null) {
         ...
         System.out.println("- " + string + "._routingPolicy:"
               + Util.objectToString(_routingPolicy));
         Util.diffRepresentationMaps(_secondaryIps, null, string
               + "._secondaryIps");
         System.out.println("- " + string + "._subnet:"
               + Util.objectToString(_subnet));
         System.out.println("- " + string + "._switchportMode:"
      ...
      if (!Util.equalOrNull(_routingPolicy, rhs._routingPolicy)) {
         System.out.println("- " + string + "._routingPolicy:"
               + Util.objectToString(_routingPolicy));
         System.out.println("+ " + string + "._routingPolicy:"
               + Util.objectToString(rhs._routingPolicy));
      }
      Util.diffRepresentationMaps(_secondaryIps, rhs._secondaryIps, string
            + "._secondaryIps");
